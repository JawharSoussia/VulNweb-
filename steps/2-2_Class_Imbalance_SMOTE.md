...
- [ ] SMOTE handler created
- [ ] Class imbalance ratio analyzed
- [ ] SMOTE applied to training data
- [ ] Model trained with SMOTE-augmented data
- [ ] Performance compared (with vs without SMOTE)
- [ ] Best model selected and saved
- [ ] Recall ≥ 90% achieved
- [ ] Commit: `git add . && git commit -m "Add SMOTE for class imbalance handling"`
